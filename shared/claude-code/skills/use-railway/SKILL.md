...
allowed-tools: Bash(railway:*), Bash(which:*), Bash(command:*), Bash(vp:*), Bash(vpx:*), Bash(pnpm:*), Bash(pnpm dlx:*), Bash(curl:*), Bash(python3:*)
---
...
vp i -g @railway/cli # vp (macOS, Linux, Windows). Requires vite+ and node
```
