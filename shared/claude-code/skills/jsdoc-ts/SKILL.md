---
name: jsdoc-ts
description: Write JSDoc comments for TypeScript functions, classes, and modules. Use when adding, editing, or reviewing JSDoc comments, or when asked to document TypeScript code.
---

# JSDoc Comments (TypeScript)

Write JSDoc comments for TypeScript functions, classes, and modules.
